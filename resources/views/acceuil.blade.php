                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                ...
                                <a href="#" class="btn medilife-btn mt-50" data-animation="fadeInUp" data-delay="70ms" data-toggle="modal" data-target="#exampleModal" id="buton">Se Connecter à mon espace <span>-></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="100ms">Des Services Medicaux 100% <br>Digne de Confiance</h2>
                                <h6 data-animation="fadeInUp" data-delay="400ms">Lorem ipsum dolor sit amet, consectetuer adipiscing elit sed diam nonummy nibh euismod.</h6>
                                <button class="btn medilife-btn mt-50" data-animation="fadeInUp" data-delay="70ms" data-toggle="modal" data-target="#exampleModal" type="button" id="buton">Se Connecter à mon espace <span>-></span></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="medilife-book-an-appoinment-area">
            <div class="container">
                        <div class="appointment-form-content">
                            <div class="no-gutters align-items-center mt-10">
                                    <div class="d-flex justify-content-around ">
                                        <!-- Single Contact Info -->
                                        <div class="single-contact-info mb-30">
                                            <img src="{{asset('img/icons/alarm-clock.png')}}" alt="">
                                            <p>Lundi - Sam 08:00 - 21:00 <br>Fermé dimache</p>
                                        </div>
                                        <!-- Single Contact Info -->
                                        <div class="single-contact-info mb-30">
                                            <img src="{{asset('img/icons/envelope.png')}}" alt="">
                                            <p>221 78 445 51 97 <br>gaye95cheikh@gmail.com</p>
                                        </div>
                                        <!-- Single Contact Info -->
                                        <div class="single-contact-info">
                                            <img src="{{asset('img/icons/map-pin.png')}}" alt="">
                                            <p>Dakar Ngor-Almadies</p>
                                        </div>
                                    </div>
                            </div>
                        </div>
